...
from Conexion_Creacion_Tablas import crear_tablas_redshift
from Carga import (
    cargar_dataframe_accion_en_redshift,
    cargar_dataframe_fecha_en_redshift,
...
def obtener_info_acciones(config):
    """
    Obtiene información de acciones desde Alpha Vantage.
    """
...
def guardar_dataframes_en_excel(df_stock_data_staging, df_dim_fecha, df_fac_precio_acciones, df_dim_acciones,
                                nombre_archivo):
    """
